...
namespace common\assets\Hitbtc;

use GuzzleHttp\Client as HttpClient;
use GuzzleHttp\Handler\CurlHandler;
use GuzzleHttp\HandlerStack;
use GuzzleHttp\Message\Response;
use common\assets\Hitbtc\Exception\InvalidRequestException;
use common\assets\Hitbtc\Exception\RejectException;
use common\assets\Hitbtc\Model\BalanceMain;
use common\assets\Hitbtc\Model\BalanceTrading;
use common\assets\Hitbtc\Model\NewOrder;
use common\assets\Hitbtc\Model\Order;
use common\assets\Hitbtc\Model\Trade;
